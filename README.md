...
2.  **Open the Project:**
    Open the cloned project directory in Xcode.

3.  **Verify Model Inclusion:**
    Ensure the necessary `.mlmodel` file is correctly placed within the **Resources** folder of the project.

4.  **Run on Device:**
    Select your physical iPhone as the target and run the app.
